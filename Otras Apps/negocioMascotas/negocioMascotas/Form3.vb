...
Public Class Form3
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Dim BUSCAR = "SELECT * FROM Raza WHERE id=@Id"
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            Dim Insertar = "Insert Into Raza Values (@Id, @Nombre,@Tamano,@Peso,@Origen, @Fotografia)"
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        Try
            Dim Actualizar = "UPDATE Raza SET id=@Id, Nombre=@Nombre, Tam=@Tamano, Peso=@Peso, Origen=@Origen,  Fotografia=@Fotografia WHERE id=@Id"
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        Try
            Dim Eliminar = "DELETE FROM Raza WHERE id=@Id"
