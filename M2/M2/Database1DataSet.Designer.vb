...
Partial Public Class Database1DataSet
    ...
    Partial Public Class PersonaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddPersonaRow(ByVal Id As String, ByVal nombre As String, ByVal telefono As String, ByVal foto() As Byte) As PersonaRow
            Dim rowPersonaRow As PersonaRow = CType(Me.NewRow,PersonaRow)
            Dim columnValuesArray() As Object = New Object() {Id, nombre, telefono, foto}
    ...
    Partial Public Class PersonaRow
        ...
        Public Function IsfotoNull() As Boolean
            Return Me.IsNull(Me.tablePersona.fotoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetfotoNull()
            Me(Me.tablePersona.fotoColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class PersonaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Persona` WHERE ((`Id` = ?) AND ((? = 1 AND `nombre` IS NULL) OR (`no"& _ 
                "mbre` = ?)) AND ((? = 1 AND `telefono` IS NULL) OR (`telefono` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Persona` (`Id`, `nombre`, `telefono`, `foto`) VALUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Persona` SET `Id` = ?, `nombre` = ?, `telefono` = ?, `foto` = ? WHERE ((`"& _ 
                "Id` = ?) AND ((? = 1 AND `nombre` IS NULL) OR (`nombre` = ?)) AND ((? = 1 AND `t"& _ 
                "elefono` IS NULL) OR (`telefono` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.M2.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, nombre, telefono, foto FROM Persona"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet.PersonaDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet.PersonaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet.PersonaDataTable = New Database1DataSet.PersonaDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database1DataSet.PersonaDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As String, ByVal Original_nombre As String, ByVal Original_telefono As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Id As String, ByVal nombre As String, ByVal telefono As String, ByVal foto() As Byte) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Id As String, ByVal nombre As String, ByVal telefono As String, ByVal foto() As Byte, ByVal Original_Id As String, ByVal Original_nombre As String, ByVal Original_telefono As String) As Integer
            If (Id Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Id")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal telefono As String, ByVal foto() As Byte, ByVal Original_Id As String, ByVal Original_nombre As String, ByVal Original_telefono As String) As Integer
            Return Me.Update(Original_Id, nombre, telefono, foto, Original_Id, Original_nombre, Original_telefono)
        End Function
    End Class
